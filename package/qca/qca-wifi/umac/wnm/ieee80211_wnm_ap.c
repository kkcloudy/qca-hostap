                                   ...
                                   struct ieee80211_bstm_reqinfo_target * bstm_reqinfo)
{
    ...
    for (i = 0; i<bstm_reqinfo->num_candidates; i++) {
        /* fill in neighbor response info

           NOTE: These fields left as 0 in other calls to add
           neighbor reports (and seem to be ignored by STAs).
                             ...
                             struct ieee80211_action_bstm_resp *bstm_resp, int frm_len)
{
   ...
   resp.termination_delay = bstm_resp->trem_delay;
