...
{
	return hostapd_driver_init(iface);
}


int hostapd_setup_iface(struct hostapd_iface *iface)
{
	return hostapd_setup_interface(iface);
}
			       ...
			       const char *entropy_file)
{
	...
	//hostapd_logger_register_cb(hostapd_logger_cb); // zhaoyang1 modifies for hostap debug 2015-04-03
